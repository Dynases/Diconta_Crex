...
Public Class PR_BalanceGeneral
    ...
    Private Sub _prCargarReporte()
        ...
        End If
        Dim dt As DataTable
        If tbPeriodo.Value = True Then
            dt = L_prCuentaReporteBalanceGeneral(gi_empresaNumi, tbFechaDel.Value.ToString("yyyy/MM/dd"), tbFechaAl.Value.ToString("yyyy/MM/dd"), numiModulo, numiSuc)
        Else
            dt = L_prCuentaReporteBalanceGeneral2(gi_empresaNumi, tbFechaDel.Value.ToString("yyyy/MM/dd"), tbFechaAl.Value.ToString("yyyy/MM/dd"), numiModulo, numiSuc)
        End If
