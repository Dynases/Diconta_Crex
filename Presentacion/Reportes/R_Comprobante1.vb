...
Public Class R_Comprobante1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_Comprobante1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_Comprobante1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_Comprobante1 = New R_Comprobante1()
        rpt.Site = Me.Site
        Return rpt
    End Function
