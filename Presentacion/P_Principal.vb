...
#Region "Metodos Privados"
    ...
    Private Sub _prIniciarTodo()
        ...
        L_prAbrirConexionBitacora(gs_Ip, gs_UsuarioSql, gs_ClaveSql, "BHDiconDinoCrex")
...
#End Region
    ...
    Private Sub btProductosProd_Click(sender As Object, e As EventArgs) Handles btProductosProd.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F1_ProductosProduccion
        frm._modulo = FP_Produccion
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
        superTabControl3.SelectedTabIndex = superTabControl3.Tabs.Count - 1
    ...
    Private Sub btMateriaPrima_Click(sender As Object, e As EventArgs) Handles btMateriaPrima.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F1_MateriaPrima
        frm._modulo = FP_Produccion
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
    ...
    Private Sub btOrdenProd_Click(sender As Object, e As EventArgs) Handles btOrdenProd.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F1_OrdenProduccion
        frm._modulo = FP_Produccion
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
    ...
    Private Sub btProductosProceso_Click(sender As Object, e As EventArgs) Handles btProductosProceso.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F0_ProductosProceso
        frm._modulo = FP_Produccion
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
    ...
    Private Sub btInsumos_Click(sender As Object, e As EventArgs) Handles btInsumos.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F1_Insumos
        frm._modulo = FP_Produccion
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
    ...
    Private Sub btAlmacenMP_Click(sender As Object, e As EventArgs) Handles btAlmacenMP.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F1_AlmacenMateriaPrima
        frm._modulo = FP_Produccion
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
