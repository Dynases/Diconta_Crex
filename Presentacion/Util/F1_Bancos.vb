...
#Region "METODOS SOBREESCRITOS"
    ...
    Public Overrides Sub _PMOHabilitar()
        ...
        tbCuentaContable.ReadOnly = False
    ...
    Public Overrides Sub _PMOHabilitarFocus()
        With MHighlighterFocus
            ...
            .SetHighlightOnFocus(tbCuentaContable, DevComponents.DotNetBar.Validator.eHighlightColor.Blue)
    ...
    Public Overrides Sub _PMOLimpiarErrores()
        ...
        tbCuentaContable.BackColor = Color.White
    ...
    Public Overrides Function _PMOGetListEstructuraBuscador() As List(Of Modelos.Celda)
        ...
        listEstCeldas.Add(New Modelos.Celda("canombre", True, "Nombre", 250))
        listEstCeldas.Add(New Modelos.Celda("canrocuenta", True, "Nro Cuenta", 180))
        listEstCeldas.Add(New Modelos.Celda("catc001numi", False))
        listEstCeldas.Add(New Modelos.Celda("cuenta_contable", True, "Cuenta Contable", 180))
        listEstCeldas.Add(New Modelos.Celda("caobs", False))
        listEstCeldas.Add(New Modelos.Celda("caestado", False))
    ...
    Public Overrides Sub _PMOMostrarRegistro(_N As Integer)
        ...
        With JGrM_Buscador
            ...
            NumiCuentaContable = .GetValue("catc001numi")
            tbCuentaContable.Text = .GetValue("cuenta_contable").ToString
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        Dim res As Boolean = L_prBancoGrabar(tbcodigo.Text, tbNombre.Text, tbnroCuentaBancaria.Text, NumiCuentaContable, tbObservacion.Text, nameImg, estado)
        If res Then
    ...
    Public Overrides Function _PMOModificarRegistro() As Boolean
        ...
        If (Modificado = False) Then
            res = L_prBancoModificar(tbcodigo.Text, tbNombre.Text, tbnroCuentaBancaria.Text, NumiCuentaContable, tbObservacion.Text, nameImg, estado)
    ...
    Private Sub tbCuentaContable_KeyDown(sender As Object, e As KeyEventArgs) Handles tbCuentaContable.KeyDown
        If (tbNombre.ReadOnly = True) Then
            Return
        End If
        ...
        If (e.KeyData = Keys.Control + Keys.Enter) Then
            ...
            Dim listEstCeldas As New List(Of Modelos.Celda)
            listEstCeldas.Add(New Modelos.Celda("canumi", False, "Nro Cuenta", 100))
            listEstCeldas.Add(New Modelos.Celda("cacta", True, "Nro Cuenta", 100))
                ...
                If (bandera = True) Then
                    ...
                    If (IsNothing(Row)) Then
                        Return
                    End If
                NumiCuentaContable = Row.Cells("canumi").Value
                tbCuentaContable.Text = Row.Cells("cacta").Value.ToString
            End If
