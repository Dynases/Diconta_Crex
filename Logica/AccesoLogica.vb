...
Sucursal.canumi =ZY003.ydsuc"
        Else
            _Where = "ZY003.ydnumi=ZY003.ydnumi and ZY002.ybnumi=ZY003.ydrol and TC004.cenumi=ZY003.ydemp and 
Sucursal.canumi =ZY003.ydsuc" + _Cadena
        End If
        _Tabla = D_Datos_Tabla("ZY003.ydnumi,ZY003.yduser,ZY003.ydpass,ZY003.ydest,ZY003.ydcant,ZY003.ydfontsize,ZY002.ybnumi,ZY002.ybrol,ZY003.ydsuc,ZY003.ydall,ZY003.ydemp,TC004.cedesc,Sucursal.cadesc", "ZY003,ZY002,TC004,Sucursal ", _Where + " order by ydnumi")
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
...
#Region "CUENTAS"
    ...
    Public Shared Function L_prCuentaReporteBalanceGeneral(_numiEmp As String, _fechaDel As String, _fechaAl As String, _numiAux1 As String, _numiAux2 As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prCuentaReporteBalanceGeneral2(_numiEmp As String, _fechaDel As String, _fechaAl As String, _numiAux1 As String, _numiAux2 As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prCuentaReporteEstadoCuentasActivoPasivo(_numiEmp As String, _fechaDel As String, _fechaAl As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prCuentaReporteEstadoCuentasActivoPasivoSinGestion(_numiEmp As String, _fechaDel As String, _fechaAl As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "COMPROBANTE"
    ...
    Public Shared Function L_prComprobanteGrabarIntegracion(ByRef _numi As String, _numDoc As String, _tipo As String, _anio As String, _mes As String, _num As String, _fecha As String, _tipoCambio As String, _glosa As String, _obs As String, _numiEmpresa As String, _detalle As DataTable, _detalle2 As DataTable, _ifnumi As String, _ifto001numi As Integer, _iftc As Double,
                                                            ...
                                                            tipo As Integer, factura As Integer, fechai As String, fechaf As String, _oaTipo As Integer, _dtTC009 As DataTable) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@TO00111", "", _dtTC009))
    ...
    Public Shared Function L_ExisteNumeroComprobante(_tipo As String, _anio As String, _mes As String, _num As String, _numi As String) As Boolean
        ...
        Return _resultado
    End Function
    Public Shared Function L_VerificarCuenta(_idcuenta As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 12))
        _listParam.Add(New Datos.DParametro("@idcuenta", _idcuenta))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
...
#Region "TS002 Dosificacion"
    ...
    Public Shared Function L_fnListarPlantillas() As DataTable
        Dim _Tabla As DataTable
...
#Region "VENTA LAVADERO"
    ...
    Public Shared Function L_fnGrabarVentaLavadero(ByRef _vcnumi As String, _vcsector As Integer, _vcSecNumi As String, _vcnumivehic As Integer, _vcalm As Integer, _vcfdoc As String, _vcclie As Integer, _vcfvcr As String, _vctipo As Integer, _vcest As Integer, _vcobs As String, _vcdesc As Double, _vctotal As Decimal, _detalle As DataTable, _CodClienteCredito As Integer,
        ...
        If (_vcsector = -10 And _vcclie > 0) Then
            _listParam.Add(New Datos.DParametro("@TV0023", "", _dtDetalleVentas))
        Else
            If (_vcsector <> -10) Then
                _listParam.Add(New Datos.DParametro("@TV0022", "", _dtDetalleVentas))
            End If
...
#Region "COMPRAS EN COMPROBANTES"
    ...
    Public Shared Function L_prCompraComprobanteGeneralLibroCompra(anio As String, mes As String, _emp As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prCompraComprobanteGeneralLibroCompra2(anio As String, mes As String, _emp As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "COMPROBANTES MARCOS"
    ...
    Public Shared Function L_prIntegracionBanco(_ifnumi As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prServicioListarCuentas(id As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prServicioListarCuentasBAncosPorCobrar(id As String, FechaI As String, FechaF As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prObtenerTotalesTransaccion(tipo As Integer, factura As Integer, fechai As String, fechaf As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prObtenerPagosTotalesPorCobrar(fechai As String, fechaf As String) As DataTable
        ...
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 45))
        _listParam.Add(New Datos.DParametro("@seuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@fechaI", fechai))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaf))
        _Tabla = D_ProcedimientoConParam("sp_Mam_Asiento", _listParam)
    ...
    Public Shared Function L_prObtenerPagosTotalesCuentaByBanco(fechai As String, fechaf As String, _canumi As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prObtenerPagosTotalesCAJA(fechai As String, fechaf As String) As DataTable
    ...
    Public Shared Function L_prListarProveedorCreditoParaTC009(fechai As String, fechaf As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 53))
        _listParam.Add(New Datos.DParametro("@seuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@fechaI", fechai))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaf))
        _Tabla = D_ProcedimientoConParam("sp_Mam_Asiento", _listParam)
    ...
    Public Shared Function L_prListarProveedorCreditoParaTC009ParaVentas(fechai As String, fechaf As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prListarProveedorCreditoParaTC009Recibo(fechai As String, fechaf As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 54))
        _listParam.Add(New Datos.DParametro("@seuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@fechaI", fechai))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaf))
        _Tabla = D_ProcedimientoConParam("sp_Mam_Asiento", _listParam)
    ...
    Public Shared Function L_prListarProveedorCreditoParaTC009Cobros(fechai As String, fechaf As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 58))
        _listParam.Add(New Datos.DParametro("@seuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@fechaI", fechai))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaf))
        _Tabla = D_ProcedimientoConParam("sp_Mam_Asiento", _listParam)
    ...
    Public Shared Function L_prListarProveedorCreditoParaTC009Pagos(fechai As String, fechaf As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prBancoGrabar(ByRef _canumi As String, _canombre As String,
                                           _cacuenta As String, _catc001 As Integer, _caobs As String,
        ...
        _listPalam.Add(New Datos.DParametro("@catc001numi", _catc001))
